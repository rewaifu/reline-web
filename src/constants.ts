import { CannyType, CvtType, DotType, DType, FilterType, HalftoneMode, NodeType, ReaderNodeMode, ResizeType, TilerType, WriterNodeFormat } from "./types/enums"
...
export const DEFAULT_NODES: StackNode[] = [
  { id: 0, type: NodeType.FOLDER_READER, options: DEFAULT_NODE_OPTIONS.folder_reader, collapsed: DEFAULT_COLLAPSED },
  { id: 1, type: NodeType.UPSCALE, options: DEFAULT_NODE_OPTIONS.upscale, collapsed: DEFAULT_COLLAPSED },
  { id: 2, type: NodeType.SHARP, options: DEFAULT_NODE_OPTIONS.sharp, collapsed: DEFAULT_COLLAPSED },
  { id: 3, type: NodeType.SCREENTONE, options: DEFAULT_NODE_OPTIONS.screentone, collapsed: DEFAULT_COLLAPSED },
  { id: 4, type: NodeType.RESIZE, options: DEFAULT_NODE_OPTIONS.resize, collapsed: DEFAULT_COLLAPSED },
  { id: 5, type: NodeType.LEVEL, options: DEFAULT_NODE_OPTIONS.level, collapsed: DEFAULT_COLLAPSED },
  { id: 6, type: NodeType.FOLDER_WRITER, options: DEFAULT_NODE_OPTIONS.folder_writer, collapsed: DEFAULT_COLLAPSED },
]
